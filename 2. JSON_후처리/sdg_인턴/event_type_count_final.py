...
root = "C:\\Users\\이성재\\OneDrive - 데이터누리\\회사\\3. 2023 사업\\4. AI 학습용데이터\\01. 한국어_다중이벤트\\13.1 데이터\\1. JSON 데이터\\final\\이벤트_재전송_231123\\이벤트_통폐합\\trainning\\"
#root = "C:\\Users\\user\\Downloads\\" + str(Day) + "\\" + "\\home\\13-2MEE\\" # 트레이닝 디렉토리 루트 ~\\202310~
csv_root = "C:\\Users\\이성재\\OneDrive - 데이터누리\\회사\\3. 2023 사업\\4. AI 학습용데이터\\01. 한국어_다중이벤트\\13.1 데이터\\1. JSON 데이터\\final\\이벤트_재전송_231123\\이벤트_통폐합\\" # ***home 하위폴더(13-2MEE있는 위치)에 첨부한 csv_last, result폴더를 둘 것***
